...
class parametricCone(parametricObject):
    ...
    def getPoint(self,u,v):
        ...
        # Setting the matrix with the equations of a cone
        P.set(0,0,(self.__height*(1-u))/self.__height*self.__radius*cos(v))
        P.set(1,0,(self.__height*(1-u))/self.__height*self.__radius*sin(v))
